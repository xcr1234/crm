	...
	<body>
		...
		<div class="rightinfo">
			...
			<div class="tools">
				...
				<ul class="toolbar">
					<li class="click"><span><img src="images/ico02.png" /></span>按客户转移</li>
					<li class="click"><span><img src="images/ico02.png" /></span>按销售负责人转移</li>
			...
			<table class="imgtable">
				...
				<tbody>
					...
					<tr>
						<td class="imgtd"><img src="images/ico02.png" /></td>
