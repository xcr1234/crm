        ...
        <form action="${pageContext.servletContext.contextPath}/ggkhc.do?method=update&customerid=${customer.id}" method="post" name="kh_form">
            <table>
                <tr>
                    ...
                    <td><input name="customer_name" type="text" class="dfinput" value="${customer.name}" /><i></i></td>
       ...
       <c:if test="${fn:length(list) gt 0}">
        <tr>
             ...
             <c:forEach items="${list}" var="link">
                ...
                <td><input type="text" name="listCustomerLink_email" value="${link.email}" /></td>
                <td><input type="text" name="listCustomerLink_birthdate" id="d11" onClick="WdatePicker()" value="${link.birthdate}" /></td>
                <td ><input type="text" name="listCustomerLink_content" value="${link.content}" /></td>
